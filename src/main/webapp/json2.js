...
function ConvertJsonToTable(parsedJson, tableId, tableClassName, linkText)
{
    ...
    var tbl = '<style>table, th, td { border: 1px solid black;  border-collapse: collapse;} th, td { padding: 15px;} </style><table cellpadding="10" color="red" border="1" cellspacing="1"' + idMarkup + classMarkup + '>{0}{1}</table>';
    ...
    var tr = '<tr>{0}</tr>';
    var thRow = '<th align="center">{0}</th>';
    var tdRow = '<td align="left">{0}</td>';
    var thCon = '';
    var tbCon = '';
    var trCon = '';
